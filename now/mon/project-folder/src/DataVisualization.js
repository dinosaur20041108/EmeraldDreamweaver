...
function DataVisualization({ parameters }) {
    ...
    datasets: [
      {
        ...
        data: Mt_CO2e_data.slice(currentStartYear - 1990, currentStartYear - 1979).map(value => value * parameters.gasEmission/100 * (0.9 + parameters.carToElectricRatio/50  ) * parameters.energyGrowth/100  ),
        borderColor: "red",
        fill: false,
      },
    ],
  ...
  const currentYearData = {
    Mt_CO2e: Mt_CO2e_data[currentStartYear- 1980] * parameters.gasEmission/100 * (0.9 + parameters.carToElectricRatio/50  ) * parameters.energyGrowth/100,
